(function () {
  ...
  onReady(function () {
    ...
    document.querySelectorAll("[data-experience-collapsible]").forEach(function (heading) {
      ...
      if (!panel || !panel.matches(".section-content-panel, .experience-list")) {
        return;
      }

      var panelId = heading.id + "-content";
      panel.id = panelId;
      panel.classList.add("experience-collapse-panel");
      ...
      chevron.className = "experience-toggle-chevron";
    ...
    function revealHash(shouldScroll) {
      ...
      if (shouldScroll) {
        window.requestAnimationFrame(function () {
          disclosure.heading.scrollIntoView({ block: "start" });
        });
      }
    }
